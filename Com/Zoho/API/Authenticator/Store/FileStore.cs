    ...
    public class FileStore : ITokenStore
    {
        ...
        public IToken FindToken(IToken token)
        {
            ...
            try
            {
                ...
                OAuth2 oauthToken = (OAuth2)token;
        ...
        private bool CheckCondition(OAuth2 oauthToken, string[] nextRecord)
        {
            bool isRowPresent = false;
        ...
        private void SetMergeData(OAuth2 oauthToken, string[] nextRecord)
        {
		    if (oauthToken.Id == null)
		    {
        ...
        private string SetToken(OAuth2 oauthToken)
        {
